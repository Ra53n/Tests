...
class DetailsActivityEspressoTest {
    ...
    fun activityTextView_NotNull() {
        scenario.onActivity {
            val totalCountTextView = it.findViewById<TextView>(R.id.totalCountDetailsTextView)
    ...
    fun activityTextView_IsDisplayed() {
        onView(withId(R.id.totalCountDetailsTextView)).check(matches(isDisplayed()))
    }

    @Test
    fun activityTextView_IsCompletelyDisplayed() {
        onView(withId(R.id.totalCountDetailsTextView)).check(matches(isCompletelyDisplayed()))
    }
    ...
    fun activityButtonIncrement_IsWorking() {
        ...
        onView(withId(R.id.totalCountDetailsTextView)).check(matches(withText("Number of results: 1")))
    }
